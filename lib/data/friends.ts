...
• сушеные цветки`,
    thumbnail: "/friend-media/cocktail-design/description-thumbnail.png",
    category: "Друг",
    ...
    subfolders: [
      {
        ...
        name: "Cocktail Design",
        logo: "/friend-media/cocktail-design/logo.png",
        files: [
          {
          ...
          },
          {
            ...
            name: "Отпечаток льда",
            type: "image",
            filePath: "/friend-media/cocktail-design/1.png",
            friendId: "cocktail-design",
            order: 1,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/2.png",
            friendId: "cocktail-design",
            order: 2,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/3.png",
            friendId: "cocktail-design",
            order: 3,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/4.png",
            friendId: "cocktail-design",
            order: 4,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/5.png",
            friendId: "cocktail-design",
            order: 5,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/6.png",
            friendId: "cocktail-design",
            order: 6,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/7.png",
            friendId: "cocktail-design",
            order: 7,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/8.png",
            friendId: "cocktail-design",
            order: 8,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/cocktail-design/9.png",
            friendId: "cocktail-design",
            order: 9,
          },
          {
            ...
            name: "Фирменный стрейнер",
            type: "video",
            filePath: "/friend-media/cocktail-design/video1.mp4",
            friendId: "cocktail-design",
            order: 10,
          },
          {
            ...
            type: "video",
            filePath: "/friend-media/cocktail-design/video2.mp4",
            friendId: "cocktail-design",
            order: 11,
          },
          {
            ...
            type: "video",
            filePath: "/friend-media/cocktail-design/video3.mp4",
            friendId: "cocktail-design",
            order: 12,
          },
          {
            ...
            type: "video",
            filePath: "/friend-media/cocktail-design/video4.mp4",
            friendId: "cocktail-design",
            order: 13,
          },
        ],
...
Проект, созданный барными энтузиастами Алексеем Токаревым и Сергеем Жигаловым, чтобы вернуть на рынок качественное барное стекло по честным ценам.

ENJOY — это ручная выдувка на одном из лучших китайских заводов бессвинцового хрусталя, где делают коллекции для лучших брендов Европы. В ассортименте также имеется линейка машинного производства.

Что предлагает ENJOY:
• универсальная посуда и собственные разработки с нуля
• гравировка на заказ
• отгрузки по всей России, два склада с логистикой в Москве
• более 500 клиентов — среди них Pinsky, Lucky Group, Васильчуки, FOLK team, Steak it Easy и другие
...
Адрес: Москва, ул. Щипок 28 (10 минут от ст. м. Павелецкая)`,
    thumbnail: "/friend-media/enjoy-barware/logo.jpg",
    category: "Друг",
    ...
    subfolders: [
      {
        ...
        name: "Enjoy Barware",
        logo: "/friend-media/enjoy-barware/logo.jpg",
        files: [
          {
          ...
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/enjoy-barware/1.jpg",
            friendId: "enjoy-barware",
            order: 1,
          },
          {
            ...
            name: "CONVALLARIA",
            type: "image",
            filePath: "/friend-media/enjoy-barware/2.jpg",
            friendId: "enjoy-barware",
            order: 2,
          },
          {
            ...
            name: "Shiraz",
            type: "image",
            filePath: "/friend-media/enjoy-barware/3.jpg",
            friendId: "enjoy-barware",
            order: 3,
          },
          {
            ...
            name: "Uni Rocks",
            type: "image",
            filePath: "/friend-media/enjoy-barware/4.jpg",
            friendId: "enjoy-barware",
            order: 4,
          },
          {
            ...
            name: "Universal New",
            type: "image",
            filePath: "/friend-media/enjoy-barware/5.jpg",
            friendId: "enjoy-barware",
            order: 5,
          },
          {
            ...
            type: "video",
            filePath: "/friend-media/enjoy-barware/video1.mp4",
            friendId: "enjoy-barware",
            order: 6,
          },
          {
            ...
            name: "Гимлет",
            type: "video",
            filePath: "/friend-media/enjoy-barware/video2.mp4",
            friendId: "enjoy-barware",
            order: 7,
          },
          {
            ...
            type: "video",
            filePath: "/friend-media/enjoy-barware/video3.mp4",
            friendId: "enjoy-barware",
            order: 8,
          },
        ],
  ...
  },
  {
    ...
    fullDescription: `STEELBAR — российская компания, которая разрабатывает и производит барные станции и нейтральное оборудование для баров, ресторанов и отелей в России и за рубежом.

Основал компанию Алексей Токарев — выходец из Simple, Happy Trade, серийный предприниматель. В индустрии с 2015 года, есть опыт, насмотренность и чувство стиля.

В основе подхода компании — эргономика, выгода и дизайн. STEELBAR проектирует решения, которые:
• ускоряют работу команды
• повышают эффективность пространства
• усиливают визуальную концепцию заведения

С 2022 года STEELBAR реализует проекты для заведений разного масштаба — от небольших коктейльных баров до сетевых форматов.

В портфолио такие партнёры, как холдинг WRF, Lucky group, Folk team, Vasilchuki, Pub Life, The Бык, Hokkah Place, Менделеев бар и другие.`,
    thumbnail: "/friend-media/steelbar/logo.png",
    category: "Друг",
    ...
    subfolders: [
      {
        id: "steelbar-folder",
        name: "Steelbar",
        logo: "/friend-media/steelbar/logo.png",
        files: [
          {
            id: "desc-steelbar",
            name: "О Steelbar",
          ...
          },
          {
            ...
            name: "Вид сверху",
            type: "image",
            filePath: "/friend-media/steelbar/1.jpg",
            friendId: "steelbar",
            order: 1,
          },
          {
            ...
            name: "Макет станции",
            type: "image",
            filePath: "/friend-media/steelbar/2.jpg",
            friendId: "steelbar",
            order: 2,
          },
          {
            ...
            type: "image",
            filePath: "/friend-media/steelbar/3.jpg",
            friendId: "steelbar",
            order: 3,
          },
          {
            ...
            name: "Станция",
            type: "image",
            filePath: "/friend-media/steelbar/4.jpg",
            friendId: "steelbar",
            order: 4,
          },
        ],
