      ...
      desktopIcons.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <span 
              className="text-base text-center font-bold drop-shadow-[1px_1px_0_#000] group-hover:bg-[#FFD700] group-hover:text-black px-2 py-0.5 transition-colors duration-200"
              style={{
