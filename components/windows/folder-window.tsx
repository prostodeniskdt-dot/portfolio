            ...
            {folderItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isPromo && (
                    <span 
                      className="absolute -top-2 -right-2 px-2 py-0.5 text-xs font-bold animate-pulse"
                      style={{
                        background: "#FF0000",
                        color: "#FFFFFF",
                  ...
                  {hasSubscribers && (
                    <span 
                      className="absolute top-1 left-1 px-1 py-0.5 text-[10px] font-bold"
                      style={{
                        background: "#0088cc",
                        color: "#ffffff",
                      }}
                  ...
                  {hasPrice && !isPromo && (
                    <span 
                      className="absolute top-1 right-1 px-1 py-0.5 text-[11px] font-bold"
                      style={{
                        background: "#000000",
                        color: "#FFD700",
                      }}
                  ...
                  <span className="text-sm font-bold text-center text-black group-hover:text-black">
                    {item.title}
                  </span>
                  <span className="text-xs text-center text-[#666666] group-hover:text-black line-clamp-2">
                    {item.description}
                  </span>
                  ...
                  {isInDevelopment && (
                    <span className="text-xs text-center text-[#666666] font-bold mt-1">
                      В разработке
                    </span>
                  )}
                </button>
