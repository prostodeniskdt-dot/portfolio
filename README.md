...
Каждая папка рабочего стола и основные окна доступны по отдельному URL:

| Раздел | URL |
|--------|-----|
| Главная | `/` |
| Продукты | `/products` |
| Индивидуальные продукты | `/individual-products` |
| IT-продукты | `/it-products` |
| Вакансии | `/vacancies` |
| Реклама | `/advertising` |
| Конкурсы | `/contest` |
| Друзья | `/friends` |
...
Партнёры в папке «Друзья»:

- `/friends/cocktail-design`
- `/friends/enjoy-barware`
- `/friends/steelbar`

При открытии раздела с рабочего стола адрес в браузере обновляется автоматически.
